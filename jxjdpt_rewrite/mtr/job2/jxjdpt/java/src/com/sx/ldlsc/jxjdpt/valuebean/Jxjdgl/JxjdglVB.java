package com.sx.ldlsc.jxjdpt.valuebean.Jxjdgl;

public class JxjdglVB { 
	/**
     *基地id
     */
    private String jdid;
	...
	/**
	 * @param sbqxmc the sbqxmc to set
	 */
	...
	/**
	 * @param ylrgws the ylrgws to set
	 */
	public void setYlrgws(String ylrgws) {
		this.ylrgws = ylrgws;
	}
	/**
	 * @return the ylrgws
	 */
	public String getYlrgws() {
		return ylrgws;
	}
